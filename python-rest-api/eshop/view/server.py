...
from eshop.view.product_schemas import ProductCreateDtoSchema, ProductGetManyParams, ProductSchema
...
def product_get_many_endpoint():
    try:
        order_get_many_params = ProductGetManyParams().load(request.args)
    except ValidationError as err:
        return err.messages, 400
